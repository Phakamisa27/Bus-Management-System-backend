# ============================================================================
# ROUTE MATCHING PAUSED
# ----------------------------------------------------------------------------
# The whole module below is commented out while route-point verification is on
# hold. POST /buses/{bus_id}/location currently accepts ALL locations because
# the import and the check are also commented out in api/bus_routes.py.
#
# To re-enable: uncomment everything below, restore the UMLAZI_WESTMEAD_CORRIDOR
# definition (it is referenced by ROUTE_PATHS), and uncomment the marked lines
# in api/bus_routes.py.
# ============================================================================
